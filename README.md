# Welcome to the Virtual Reality mobile application named ARProject6🤖🚗
An application that is in charge of taking a specific image through Ground and once the user chooses the exact site to implement the model, the application will proceed to display a 3D design, in this case it would be different models in which we will have a robot and a car.
...
> 4.- And finally, the respective Target Images will appear on the initial screen with the previously mentioned models
   ...
   | <img src="https://github.com/kvto/ARPRoject6/blob/main/Imagenes/modelcar.png" width="285px" align="center"> | <img src="https://github.com/kvto/ARPRoject6/blob/main/Imagenes/modelrobot.png" width="285px" align="center"> 
|---|---|
